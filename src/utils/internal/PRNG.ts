...
interface Random extends Function {
  addEntropy?: Function;
...
const Mash = function () {
  var n = 0xefc8249d;
  var mash = function (data?: any): number {
    if (data) {
...
const uheprng = function () {
  return (function () {
    ...
    var random: Random = function (range: number): number {
      return Math.floor(
        range *
    ...
    random.string = function (count: number): string {
      var i;
      var s = "";
      for (i = 0; i < count; i++) {
    ...
    random.cleanString = function (inStr: string): string {
    ...
    random.hashString = function (inStr: string): void {
    ...
    random.seed = function (s: any): void {
      if (typeof s === "undefined" || s === null) {
        s = Math.random();
      }
      if (typeof s !== "string") {
        s = stringify(s, function (key: string, value: any) {
    ...
    random.range = function (range: number) {
      return random(range);
    };
